...
清晰的符号意义，高对比度可见性，用于确认/取消/状态指示等交互场景。

| 图片预览 | 图片名称 | 视觉特征与用途 |
|---------|---------|----------------|
| <img src="../../Assets/Game/HotResources/RawAssets/Texture/True.png" width="80" style="background-color: #000000; padding: 5px;"> | **True.png** | 对勾图标，确认标记，白色透明背景 |
| <img src="../../Assets/Game/HotResources/RawAssets/Texture/False.png" width="80" style="background-color: #000000; padding: 5px;"> | **False.png** | 错误标记图标，账号系统使用 |
| <img src="../../Assets/Game/HotResources/RawAssets/Texture/Radar.png" width="80" style="background-color: #ffffff; padding: 5px;"> | **Radar.png** | 雷达可视化，径向渐变圆形 |

### 装饰性元素

非交互元素，用于增强视觉层级和空间感知，支持动画效果。

| 图片预览 | 图片名称 | 视觉特征与用途 |
|---------|---------|----------------|
| <img src="../../Assets/Game/HotResources/RawAssets/Texture/Ring.png" width="80" style="background-color: #000000; padding: 5px;"> | **Ring.png** | 圆环，点击反馈/遮罩动画，简单透明 |
| <img src="../../Assets/Game/HotResources/RawAssets/Texture/Border.png" width="80" style="background-color: #000000; padding: 5px;"> | **Border.png** | 边框装饰，视觉分隔框架元素 |
