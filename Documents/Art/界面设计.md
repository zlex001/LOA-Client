...
|---------|---------|---------|----------------|
| <img src="../../Assets/Game/HotResources/RawAssets/Texture/RectangleSolid.png" width="80" style="background-color: #ffffff; padding: 5px;"> | **RectangleSolid.png** | 极简主义 | 黑底白边圆角矩形框（80x40），通过颜色叠加实现多种色调的按钮和UI元素 |
