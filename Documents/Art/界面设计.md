...
**[代表性资源](#二ui图片资源总表)：** Edit.png、Focus.png、True.png、False.png
...
**文档版本：** 1.1  
**最后更新：** 2026-02-12  
**更新内容：** 移除 Increase.png 和 Decrease.png，改用文本符号实现  
**文档类型：** 美术设计规范
