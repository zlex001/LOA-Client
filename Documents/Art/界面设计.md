...
| 图片预览 | 图片名称 | 尺寸 | 应用 |
|---------|---------|------|----------------|
| <img src="../../Assets/Game/HotResources/RawAssets/Texture/RectangleSolid.png" width="80" style="background-color: #ffffff; padding: 5px;"> | **RectangleSolid.png** | 80×40 | 按钮背景、面板背景、输入框背景、对话框背景 |
| <img src="../../Assets/Game/HotResources/RawAssets/Texture/Focus.png" width="80" style="background-color: #000000; padding: 5px;"> | **Focus.png** | 1025×1025 | 按钮图标 |
| <img src="../../Assets/Game/HotResources/RawAssets/Texture/Settings.png" width="80" style="background-color: #000000; padding: 5px;"> | **Settings.png** | 2048×2048 | 按钮图标 |
| <img src="../../Assets/Game/HotResources/RawAssets/Texture/Border.png" width="80" style="background-color: #000000; padding: 5px;"> | **Border.png** | 8×8 | 边框装饰 |
| <img src="../../Assets/Game/HotResources/RawAssets/Texture/RectangleSolid%20-%20%E5%89%AF%E6%9C%AC.png" width="80" style="background-color: #ffffff; padding: 5px;"> | **RectangleSolid - 副本.png** | 80×40 | 重复文件（建议删除） |
| <img src="../../Assets/Game/HotResources/RawAssets/Texture/True.png" width="80" style="background-color: #000000; padding: 5px;"> | **True.png** | 400×200 | 复选框图标 |
| <img src="../../Assets/Game/HotResources/RawAssets/Texture/Radar.png" width="80" style="background-color: #ffffff; padding: 5px;"> | **Radar.png** | 100×100 | 雷达图背景 |
| <img src="../../Assets/Game/HotResources/RawAssets/Texture/Ring.png" width="80" style="background-color: #000000; padding: 5px;"> | **Ring.png** | 100×100 | 粒子特效（点击反馈、新手引导提示） |
...
| <img src="../../Assets/Game/HotResources/RawAssets/Texture/RadiativeRing.png" width="80" style="background-color: #000000; padding: 5px;"> | **RadiativeRing.png** | 240×136 | 装饰性背景 |
