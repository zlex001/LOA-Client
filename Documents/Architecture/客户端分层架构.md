...
{
    "name": "Logic",
    "references": ["Net", "Data", "Utils", "Basic", "Framework"]
}
```
...
```json
{
    "name": "Presentation",
    "references": [
        "Logic", "Data", "Utils", "Basic", "Framework", "Net",
...
{
    "name": "Start",
    "references": ["Framework", "Basic", "Data", "Net", "Logic", "Presentation"]
}
```
...
string[] hotUpdateDlls = new string[] 
{
    ...
    "net.dll.bytes", "logic.dll.bytes", "presentation.dll.bytes",
