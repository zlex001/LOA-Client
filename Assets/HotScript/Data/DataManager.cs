...
namespace Game.Data
{
    ...
    public partial class DataManager : Singleton<DataManager>
    {
        ...
        private void RegisterEvents()
        {
            ...
            Basic.Event.Instance.Add(Game.Presentation.Initialize.Click.Random, OnInitializeRandomClick);
            Basic.Event.Instance.Add(Game.Presentation.Initialize.Click.Confirm, OnInitializeConfirmClick);
