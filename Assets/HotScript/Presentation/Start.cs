...
namespace Game
{
    public class Start : UI.Core
    {
        ...
        private Transform CreateSettingsButton()
        {
            ...
            try
            {
                var settingsSprite = AssetManager.Instance.LoadSprite("Textures", "Settings");
                ...
                else
                {
                    ...
                    Utils.Debug.LogWarning("Start", "Settings.png not found in Textures/, using fallback color");
                }
            }
