...
namespace Game.Presentation
{
    ...
    public class Gate
    {
        public static void Entrance(string gateway)
        {
            ...
            Game.Basic.Event.Instance.Add(Game.Data.InitializeClick.Confirm, OnInitializeConfirmClick);
            Game.Basic.Event.Instance.Add(Game.Data.InitializeClick.Random, OnInitializeRandomClick);
