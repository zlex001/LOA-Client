...
public class Build
{
    ...
    public static void StartPackageBuild()
    {
        ...
        {
            string project_path = packageTempPath + "/" + $"World{AssetDatabase.LoadAssetAtPath<Config>("Assets/Framework/Config.asset").appVersion}.apk";//目标目录
            string[] outScenes = { "Assets/Framework/Main.unity" };
            BuildPipeline.BuildPlayer(outScenes, project_path, BuildTarget.Android, BuildOptions.CompressWithLz4);

            string copyPath = Path.Artifacts + "/" + "ALLOUT" + "/Export/" + $"World{AssetDatabase.LoadAssetAtPath<Config>("Assets/Framework/Config.asset").appVersion}.apk";
    ...
    private static void SetConfig()
    {
        ...
        PlayerSettings.bundleVersion = AssetDatabase.LoadAssetAtPath<Config>("Assets/Framework/Config.asset").appVersion;
    ...
    {
        Config packageConfig = AssetDatabase.LoadAssetAtPath<Config>("Assets/Framework/Config.asset");
