...
namespace Game
{
    ...
    public partial class Data : Singleton<Data>
    {
        ...
        public Protocol.Initialize Initialize { get => Get<Protocol.Initialize>(Type.Initialize); set => Change(Type.Initialize, value); }
        ...
        public Protocol.Home Home { get => Get<Protocol.Home>(Type.Home); set => Change(Type.Home, value); }
        public float SceneScale { get => Get<float>(Type.SceneScale); set => Change(Type.SceneScale, value); }
        public List<Map> Maps { get => Get<List<Map>>(Type.Maps); set => Change(Type.Maps, value); }
        ...
        public List<Protocol.Characters.CharacterData> Characters { get => Get<List<Protocol.Characters.CharacterData>>(Type.Characters); set => Change(Type.Characters, value); }
        ...
        public (UI.Tips, string) Tip { get => Get<(UI.Tips, string)>(Type.Tip); set => Change(Type.Tip, value); }
        ...
        public List<Information> Informations
        {
            get
            {
                ...
                foreach (Information information in Get<List<Information>>(Type.Informations))
                {
        ...
        void Awake()
        {
            raw[Type.Informations] = new List<Information>();
        ...
        private void OnInitializeConfirmClick(params object[] args)
        {
            ...
            Net.Instance.Send(new InitializeConfirm(name));
        }

        private void OnInitializeRandomClick(params object[] args)
        {
            Net.Instance.Send(new InitializeRandom());
        }
        ...
        private List<Map> AdaptMaps(List<Map> maps)
        {
